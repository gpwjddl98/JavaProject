...
public class MyFrame4x1 extends JFrame {
	...
	public MyFrame4x1() {
		...
		pic1.setBounds(185, 20, 230, 120);
		
		pic2 = new JButton("사진2");
		pic2.setBounds(185, 140, 230, 120);
		
		pic3 = new JButton("사진3");
		pic3.setBounds(185, 260, 230, 120);
		
		pic4 = new JButton("사진4");
		pic4.setBounds(185, 380, 230, 120);
		...
		btnUp1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				link1.setText(filePath);
				
				String n1 = link1.getText();
				System.out.println(n1);
				ImageIcon ii1 = new ImageIcon(n1);
				Image img1 = ii1.getImage();
				Image changeImg1 = img1.getScaledInstance(240, 120, Image.SCALE_SMOOTH);
		...
		btnUp2.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Image changeImg2 = img2.getScaledInstance(240, 120, Image.SCALE_SMOOTH);
		...
		btnUp3.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Image changeImg3 = img3.getScaledInstance(240, 120, Image.SCALE_SMOOTH);
		...
		btnUp4.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Image changeImg4 = img4.getScaledInstance(240, 120, Image.SCALE_SMOOTH);
